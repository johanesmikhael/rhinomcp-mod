...
{
    public JObject RebaseObjectsPose(JObject parameters)
    {
        ...
        {
            throw new InvalidOperationException("No objects provided to rebase.");
        }
        ...
        foreach (JObject parameter in objectParameters)
        {
            ...
            {
                updates.Add(RebaseObjectPose(parameter));
                rebased++;
            }
        }
