...
{
    public class RhinoMCPModServer
    {
        private string host;
        private int port;
        ...
        public RhinoMCPModServer(string host = "127.0.0.1", int port = 1999)
        {
            ...
            this.handler = new RhinoMCPModFunctions();
        }
        ...
        public void Start()
        {
            ...
            try
            {
                ...
                RhinoApp.WriteLine($"RhinoMCP_mod server started on {host}:{port}");
            }
            catch (Exception e)
            {
        ...
        public void Stop()
        {
            ...
            RhinoApp.WriteLine("RhinoMCP_mod server stopped");
        }
        ...
        private JObject ExecuteCommandInternal(string cmdType, JObject parameters)
        {
            ...
            Dictionary<string, Func<JObject, JObject>> handlers = new Dictionary<string, Func<JObject, JObject>>
            {
                ...
                ["copy_objects"] = this.handler.CopyObjects,
                ...
                ["rotate_object"] = this.handler.RotateObject,
                ["rotate_objects"] = this.handler.RotateObjects,
                ["reset_object_pose"] = this.handler.ResetObjectPose,
                ["reset_objects_pose"] = this.handler.ResetObjectsPose,
                ["rebase_object_pose"] = this.handler.RebaseObjectPose,
                ["rebase_objects_pose"] = this.handler.RebaseObjectsPose,
