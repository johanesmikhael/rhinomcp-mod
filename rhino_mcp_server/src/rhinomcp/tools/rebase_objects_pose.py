...
def rebase_objects_pose(
    ...
    Orientation is kept from each object's current pose frame and hints are
    resolved as the closest signed axis permutation in world-axis terms.
    Translation anchor is always each object's current geometry bbox center.
